...
export default function ModalDiagnosticDetails({
    isOpen,
    onClose,
    data,
    annotations,
    optionsCancellation
}: ModalDiagnosticDetailsFormProps) {
    ...
    return (
        <>
            {(isOpen && data) && (
                <div className="fixed inset-0 bg-black/30 flex justify-center z-50 md:py-5">
                    <motion.div
                    ...
                    >
                        ...
                        <DiagnosticDetails data={data} />
                        <div className="flex flex-col w-full space-y-8 mt-2">
                            {auth.role==="doctor" && <MatrixAccess data={data}/>}
                                ...
                                <div>
                                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between border-l-8 w-full border-l-mainlilly rounded-2xl pl-3 pr-4 py-4 shadow-sm gap-4">
                                        <div className="flex flex-row">
                                            ...
                                            <p className="text-base md:text-xl text-gray-800 px-4">
                                                Deseja Cancelar o Protocolo?
                                            </p>
                                        </div>
