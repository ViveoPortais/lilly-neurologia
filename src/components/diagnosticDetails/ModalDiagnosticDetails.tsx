      ...
      {isOpen && data && (
        <div className={`fixed inset-0 bg-black/30 flex ${auth.role === "logistics" ? "sm:items-center" : ""} justify-center z-50 md:py-5`}>
          <motion.div
            ...
            className="bg-white rounded-3xl pt-8 pb-4 pl-6 pr-6 shadow-lg w-full text-center w-full md:max-w-[80%] overflow-y-auto scrollbar-hidden overflow-x-none pb-10"
          >
            ...
            {auth.role !== "logistics" && (
              <div className="flex flex-col w-full space-y-8 mt-2">
                ...
                {data.hasDigitalSignature && <DigitalSignatureDetails data={digitalSignatureDetails} exam={data}/>}
