...
export const submitPatientRegistration = createAsyncThunk("registerPatient/submitPatientRegistration", async (data: ExamCreateModel, { rejectWithValue }) => {
  try {
...
export const { setSelectedDoctorId, clearSelectedDoctorId } = registerPatientSlice.actions;
