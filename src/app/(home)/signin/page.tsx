   ...
   {step === 1 && (
    <>
     ...
     <div className="w-full">
      <Input type="text" icon="login" placeholder="E-mail" className="w-full" {...register("login", { required: true })} maxLength={100} />
      {errors.login && <span className="w-full text-xs text-red-400 mt-1">{errors.login.message}</span>}
     </div>

     <div className="w-full">
      <Input type="password" icon="password" placeholder="Senha" className="w-full" {...register("password", { required: true })} />
